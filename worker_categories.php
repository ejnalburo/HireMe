...
include 'config.php';
	$sql = "SELECT COUNT(categoryID) as acad FROM jobs WHERE categoryID = '1' AND status = 'Hiring'";        
    $query =  mysqli_query($conn, $sql);
    $data = mysqli_fetch_array($query);

    $sql1 = "SELECT COUNT(categoryID) as fin FROM jobs WHERE categoryID = '2' AND status = 'Hiring'";
    $query1 =  mysqli_query($conn, $sql1);
    $data1 = mysqli_fetch_array($query1);

    $sql2 = "SELECT COUNT(categoryID) as hand FROM jobs WHERE categoryID = '3' AND status = 'Hiring'";
    $query2 =  mysqli_query($conn, $sql2);
    $data2 = mysqli_fetch_array($query2);

    $sql3 = "SELECT COUNT(categoryID) as health FROM jobs WHERE categoryID = '4' AND status = 'Hiring'";
    $query3 =  mysqli_query($conn, $sql3);
    $data3 = mysqli_fetch_array($query3);

    $sql4 = "SELECT COUNT(categoryID) as person FROM jobs WHERE categoryID = '5' AND status = 'Hiring'";
    $query4 =  mysqli_query($conn, $sql4);
    $data4 = mysqli_fetch_array($query4);

    $sql5 = "SELECT COUNT(categoryID) as rec FROM jobs WHERE categoryID = '6' AND status = 'Hiring'";
	...
	<div class="main-content">
		...
		<main>
			...
			<div class="dashboard-cards">
				<a href="academic_job.php" style="text-decoration: none; color:#000;">
				...
				<a href="financial_job.php" style="text-decoration: none; color:#000;">
				<div class="card-category">
					<div>
				...
				<a href="handyman_job.php" style="text-decoration: none; color:#000;">
				<div class="card-category">
					<div>
				...
				<a href="healthcare_job.php" style="text-decoration: none; color:#000;">
				<div class="card-category">
					<div>
				...
				<a href="personal_job.php" style="text-decoration: none; color:#000;">
				<div class="card-category">
					<div>
				...
				<a href="sport_job.php" style="text-decoration: none; color:#000;">
				<div class="card-category">
					<div>
