      ...
      <div class="search-wrapper">
        ...
        <input type="search" id="output" placeholder="Search Services">       
			...
			<?php
				...
				$sql = "SELECT a.jobID as jobworkerID, a.userID as clientID, a.categoryID as categoryID, a.jobTitle as jobTitle, a.rate as rate, a.business as business, a.lat as lat, a.lng as lng, a.jobDetails as jobDetails, b.userID as userID, b.profile as profile, b.firstname as firstname, b.lastname as lastname FROM jobs a, users b WHERE a.userID = b.userID AND a.categoryID = 4 ORDER BY dateCreated desc";
