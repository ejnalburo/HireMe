									...
									<tbody>
										<?php
											include 'config.php';
												...
												$sql1 = "SELECT DAYNAME(a.dateSched) as day, a.dateSched as dateSched, a.timeSched as timeSched, d.jobTitle as jobTitle, b.rate as rate, c.firstname as firstname, c.lastname as lastname from schedules a, jobs b, users c, workers d WHERE a.workerID = '$userID' AND d.workerID = a.jobworkerID AND d.workerID = a.jobworkerID AND a.jobworkerID = b.jobID AND b.userID = c.userID AND a.status = 'accepted' AND a.dateSched >= CURDATE() GROUP BY schedID ORDER BY a.dateSched, a.timeSched asc";
								...
								<table width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td style="align-items: center; display: flex; margin-top: 10px;">
												<a href="" style="text-decoration: none;"><i class='bx bx-star' style="font-size: 25px;color: var(--main-color); margin-right: 5px;" title="Rate"></i></a>
												<a href="" style="text-decoration: none;"><i class="bx bx-error-circle" style="font-size: 25px; color: var(--main-color);" title="Report Client">
												</i></a>
											</td>
										</tr>
									...
									<tbody>
										<?php
											include 'config.php';
												...
												$sql1 = "SELECT DAYNAME(a.dateSched) as day, a.dateSched as dateSched, a.timeSched as timeSched, d.jobTitle as jobTitle, b.rate as rate, c.firstname as firstname, c.lastname as lastname from schedules a, jobs b, users c, workers d WHERE a.workerID = '$userID' AND d.workerID = a.jobworkerID AND d.workerID = a.jobworkerID AND a.jobworkerID = b.jobID AND b.userID = c.userID AND a.status = 'cancelled' GROUP BY schedID ORDER BY a.dateSched, a.timeSched asc";
