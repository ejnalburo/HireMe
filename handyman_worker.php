	...
	<div class="main-content">
        ...
        <input type="search" id="output" placeholder="Search Services">       
			...
			<?php
				...
				$sql = "SELECT a.workerID as jobworkerID, a.userID as workerID, a.categoryID as categoryID, a.jobTitle as jobTitle, a.rate as rate, a.workExperience as workExperience, a.location as location, b.userID as userID, b.profile as profile, b.firstname as firstname, b.lastname as lastname FROM workers a, users b WHERE categoryID = '3' AND a.userID = b.userID ORDER BY dateCreated desc";
